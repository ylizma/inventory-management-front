        ...
        <form @submit.prevent="sendData">
          <div class="mt-4 mb-6">
            ...
            <div class="px-4 py-3 mb-8 rounded-lg shadow-sm dark:bg-gray-800">
              ...
              <label class="block text-sm pb-3 mt-2">
                <span class="text-gray-700 dark:text-gray-400">Quantity</span>
                <i
                  class="m-2 text-green-500"
                  v-if="choosedProduct && movementType === 'OUTCOMING'"
                  >(quantity should be less or equal then
                  {{ choosedProduct.quantity }})</i
                >
  ...
  methods: {
    async sendData() {
      ...
      const sm = {
        ...
        product: this.choosedProduct,
        movementType: this.movementType,
      };
      this.$http
        .post("/stockmovements/add", sm, config)
        .then((res) => {
          this.msg = "the movement is successfully saved !! ";
          this.success = true;
